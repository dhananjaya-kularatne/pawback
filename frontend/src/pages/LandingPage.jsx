...
// Landing page for visitors — features header, hero banner, primary CTA, feature highlights, and footer
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          ...
          <p className="flex items-center gap-1">
            Built with <Heart size={12} className="text-red-500 fill-red-500" /> for pet owners everywhere.
          </p>
